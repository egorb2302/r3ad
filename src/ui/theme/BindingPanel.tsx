 ...
 *
 * Две секции — переплёт и бумага — открываются с двух соседних плиток
 * инспектора; общий у них только способ записи: тема тома целиком.
 */
import {
  BINDINGS,
  EDGES,
