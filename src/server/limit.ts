 ...
 * `memoryLimiter` ниже.
 *
 * Первый деплой идёт с этими счётчиками как есть — решение, а не забывчивость:
 * стек сведён к одному Vercel Blob (см. vercelBlob.ts), и мягкий предел на
 * старте дешевле третьего сервиса. Ущерб ограничен дневным потолком на отдачу
 * и тем, что заливать можно только под выданный билет.
 */
