    ...
    <>
      ...
      */}
      <group ref={group} rotation={[-Math.PI / 2, 0, 0]}>
        {/*
          Лист не отсекается по пирамиде видимости: его вершины двигает шейдер,
          а габаритная сфера считается по исходной плоскости — она стоит в нуле,
          у корешка, тогда как сам лист уезжает от него на всю свою длину и
          поворачивается вокруг него на π. Стоит подойти камерой к внешнему
          краю страницы, и сфера уходит из кадра раньше листа: страница
          пропадает целиком, чаще всего на телефоне, где камера ближе.
        */}
